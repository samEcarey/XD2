...
export const ModuleFormStep3 = (props) => {
	...
	return (
		<>
				...
				<div className="Form-group">
					<label for="maidenname">Maiden Name3</label>
					<input id="maidenname" className="form-input" type="text" name="maidenname" placeholder="Enter maiden name" defaultValue="" />
				</div>
				<div className="Form-group">
				</div>
				<div className="Form-group">
					<label>Lorem ipsum dolor sit amet consectetur <br/> dolor sit amet consectetur3</label>
