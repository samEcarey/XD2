	...
	return (
      ...
      <FormGroup>
        <input 
          ...
          checked={props.columnGearFilter[props.column] === 'search'}  
        ...
        <input 
          ...
          value="sort" 
          onChange={props.handleGearColumn}
          checked={props.columnGearFilter[props.column] === 'sort'} 
        /><label>Sort</label>
      </FormGroup>
      <FormGroup layout="savecontext">
        <button name={props.column} onClick={(e) => props.handleResetColumn(e)}>Reset</button>
			</FormGroup>
		</StyledForm>
	)
}
