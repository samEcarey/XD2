      ...
      {props.stateValue.columns.map((c, idx) => (
        idx <= sortColumn.length ?
          <React.Fragment key={idx}>
            ...
            <FormGroup>
              <select name="column" value={props.stateValue.sortBy[idx].column} onChange={(e)=>props.handleChange(e,idx)}>
            ...
            <input 
              ...
              checked={props.stateValue.sortBy[idx].direction === "asc"}
            /><label>Asc</label><br/>
            <input 
              type="radio"
              name={idx}
              value="desc" 
              onChange={(e)=>props.handleChange(e,idx)}
              checked={props.stateValue.sortBy[idx].direction === "desc"}
            /><label>Desc</label>
          </FormGroup>
          </React.Fragment>
        : null
